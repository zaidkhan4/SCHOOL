            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('asign_teacher.teach_update', $asignteacher->id) }}"  method="post">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="class_id" id="class_id" class="form-control">
                                        ...
                                        <option value="{{ $value->id }}" {{ $asignteacher->class_id == $value->id ? 'selected' : ''  }}  >{{ $value->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="subject_id" id="subject_id" class="form-control">
                                        ...
                                        <option value="{{ $value->id }}" {{ $asignteacher->subject_id == $value->id ? 'selected' : ''  }} >{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="teacher_id" id="teacher_id" class="form-control">
                                        ...
                                        <option value="{{ $value->id }}" {{ $asignteacher->teacher_id == $value->id ? 'selected' : ''  }} >{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
