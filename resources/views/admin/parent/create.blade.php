                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Parent Record</h3>
                        </div>


                        <form action="{{ route('parent.parent_store') }}"  method="post">
                            @csrf
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="password" name="assword" class="form-control" id="exampleInputEmail1"
