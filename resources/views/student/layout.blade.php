        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('student.dashboard') }}" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Teacher Managment</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student.my_subject') }}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    My Subject
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student.timeables') }}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                   Timetable
                                </p>
